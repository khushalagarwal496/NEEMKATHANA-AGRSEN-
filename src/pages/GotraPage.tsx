      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-10 rounded-2xl overflow-hidden shadow-2xl border-4 border-primary/20 bg-white p-4">
              <img 
                src="/images/agrawal-gotras.png" 
                alt="18 Gotras of Agrawal Samaj" 
                className="w-full h-auto object-contain max-h-[600px] mx-auto transition-transform duration-700 hover:scale-105"
              />
              <p className="text-center text-sm text-muted-foreground mt-4 italic">महाराजा अग्रसेन द्वारा स्थापित 18 गोत्र और उनके प्रतीक</p>
            </div>
