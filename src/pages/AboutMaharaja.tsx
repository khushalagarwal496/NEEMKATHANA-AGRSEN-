            ...
            <div className="flex justify-center mb-8">
              <div className="relative group">
                ...
                <img 
                  ...
                  alt="Ek Rupaya Ek Eint - Symbol of Equality" 
                  className="relative w-64 md:w-80 h-auto drop-shadow-2xl transition-transform duration-500 group-hover:scale-110"
                />
              </div>
            </div>
