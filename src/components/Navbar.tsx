    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-foreground/95 backdrop-blur-sm border-b border-gold/20">
      <div className="container mx-auto flex items-center justify-between h-16 px-4">
        <Link to="/" className="flex items-center gap-2 group">
          <div className="w-10 h-10 rounded-full overflow-hidden border border-gold/30 transition-transform duration-300 group-hover:scale-110">
            <img src="/og-image.png" alt="अग्रोहाधाम लोगो" className="w-full h-full object-cover" />
          </div>
          <span className="text-xl font-bold text-gold uppercase tracking-wider">अग्रोहाधाम नीमकाथाना</span>
        </Link>
